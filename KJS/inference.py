...
def inference(data_dir, model_dir, output_dir, args):
    ...
    info['ans'] = preds
    save_path = os.path.join(output_dir, f'output_Adam_NfNet.csv')
...
if __name__ == '__main__':
    ...
    # train 했을 때와 모델 옵션등 모두 동일하게 가져가야함!!
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_CHANNEL_MODEL', './model/Adam_NfNet'))
